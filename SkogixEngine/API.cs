...
namespace ECS {
	...
	public static class Extensions {
		...
		public static Entity CreateEntity(this World w, ITemplate t) { return w.EntityFactory.Get(t); }
		public static Entity CreateEntity(this World w, Component c) { return w.EntityFactory.Get(c); }
		public static Entity CreateEntity(this World w, params Component[] c) { return w.EntityFactory.Get(c); }
		...
		*/
		public static void Push<T>(this EntitySystem es, T data) where T : ICommand {
			es.World.EventManager.Push(data);
		}
